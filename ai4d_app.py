...
import joblib 
import os 
import math from sklearn.linear_model 
...
def fitur_numerik(angka): angka_str = str(angka).zfill(4) as_, kop, kepala, ekor = map(int, angka_str) total = int(angka)
...
shio_list = [ "Tikus", "Kerbau", "Macan", "Kelinci", "Naga", "Ular", "Kuda", "Kambing", "Monyet", "Ayam", "Anjing", "Babi" ] shio_angka = { "Tikus": [2, 15, 28, 41], "Kerbau": [3, 16, 29, 42], "Macan": [4, 17, 30, 43], "Kelinci": [5, 18, 31, 44], "Naga": [6, 19, 32, 45], "Ular": [7, 20, 33, 46], "Kuda": [8, 21, 34, 47], "Kambing": [9, 22, 35, 48], "Monyet": [10, 23, 36, 49], "Ayam": [11, 24, 37], "Anjing": [12, 25, 38], "Babi": [1, 14, 27, 40] }
